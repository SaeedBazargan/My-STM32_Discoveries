...
/* USER CODE BEGIN PV */
AI_ALIGNED(4) ai_u8 in_data[AI_MYSINE_MODEL_IN_1_SIZE_BYTES];
AI_ALIGNED(4) ai_u8 out_data[AI_MYSINE_MODEL_OUT_1_SIZE_BYTES];
...
int main(void)
{
  ...
  ai_u8 activations[AI_MYSINE_MODEL_DATA_ACTIVATIONS_SIZE];
