...
#include "mysine_model.h"
#include "mysine_model_data.h"
...
#define AI_NET_OBJ_INSTANCE g_mysine_model
 
#undef AI_MYSINE_MODEL_MODEL_SIGNATURE
#define AI_MYSINE_MODEL_MODEL_SIGNATURE     "0x9761a37895d3aa967ec985ed9313e1cc"
...
#define AI_TOOLS_DATE_TIME   "Sat Mar 22 21:36:50 2025"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_MYSINE_MODEL_N_BATCHES
#define AI_MYSINE_MODEL_N_BATCHES         (1)

static ai_ptr g_mysine_model_activations_map[1] = AI_C_ARRAY_INIT;
static ai_ptr g_mysine_model_weights_map[1] = AI_C_ARRAY_INIT;
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    128, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_MYSINE_MODEL_IN_NUM, &serving_default_keras_tensor0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_MYSINE_MODEL_OUT_NUM, &gemm_2_output),
  &gemm_0_layer, 0x3ba8d4aa, NULL)
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_MYSINE_MODEL_MODEL_NAME,
...
AI_API_ENTRY
ai_buffer* ai_mysine_model_inputs_get(ai_handle network, ai_u16 *n_buffer)
{
...
AI_API_ENTRY
ai_buffer* ai_mysine_model_outputs_get(ai_handle network, ai_u16 *n_buffer)
{
  if (network == AI_HANDLE_NULL) {
    network = (ai_handle)&AI_NET_OBJ_INSTANCE;
    AI_NETWORK_OBJ(network)->magic = AI_MAGIC_CONTEXT_TOKEN;
...
AI_API_ENTRY
ai_i32 ai_mysine_model_forward(ai_handle network, const ai_buffer* input)
{
