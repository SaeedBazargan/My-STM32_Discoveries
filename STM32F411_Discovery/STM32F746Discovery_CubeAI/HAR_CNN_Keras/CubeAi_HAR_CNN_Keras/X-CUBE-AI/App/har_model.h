/**
  ...
  ******************************************************************************
  */
#ifndef AI_HAR_MODEL_H
#define AI_HAR_MODEL_H

#include "har_model_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_HAR_MODEL_MODEL_NAME          "har_model"
#define AI_HAR_MODEL_ORIGIN_MODEL_NAME   "model"

/******************************************************************************/
#define AI_HAR_MODEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_HAR_MODEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_HAR_MODEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_HAR_MODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_HAR_MODEL_IN \
  ai_har_model_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_HAR_MODEL_IN_SIZE { \
  AI_HAR_MODEL_IN_1_SIZE, \
}
#define AI_HAR_MODEL_IN_SIZE_BYTES { \
  AI_HAR_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_HAR_MODEL_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_HAR_MODEL_IN_1_HEIGHT      (90)
#define AI_HAR_MODEL_IN_1_WIDTH       (3)
#define AI_HAR_MODEL_IN_1_CHANNEL     (1)
#define AI_HAR_MODEL_IN_1_SIZE        (270)
#define AI_HAR_MODEL_IN_1_SIZE_BYTES  (1080)

/******************************************************************************/
#define AI_HAR_MODEL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_HAR_MODEL_OUT \
  ai_har_model_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_HAR_MODEL_OUT_SIZE { \
  AI_HAR_MODEL_OUT_1_SIZE, \
}
#define AI_HAR_MODEL_OUT_SIZE_BYTES { \
  AI_HAR_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_HAR_MODEL_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_HAR_MODEL_OUT_1_CHANNEL     (6)
#define AI_HAR_MODEL_OUT_1_SIZE        (6)
#define AI_HAR_MODEL_OUT_1_SIZE_BYTES  (24)

/******************************************************************************/
#define AI_HAR_MODEL_N_NODES (7)
 ...
 */
AI_API_ENTRY
ai_error ai_har_model_create_and_init(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_har_model_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_har_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
