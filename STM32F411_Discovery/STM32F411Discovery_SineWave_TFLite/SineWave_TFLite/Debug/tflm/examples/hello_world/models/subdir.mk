...
CC_SRCS += \
../tflm/examples/hello_world/models/hello_world_float_model_data.cc \
../tflm/examples/hello_world/models/hello_world_int8_model_data.cc 

CC_DEPS += \
./tflm/examples/hello_world/models/hello_world_float_model_data.d \
./tflm/examples/hello_world/models/hello_world_int8_model_data.d 

OBJS += \
./tflm/examples/hello_world/models/hello_world_float_model_data.o \
./tflm/examples/hello_world/models/hello_world_int8_model_data.o 


# Each subdirectory must supply rules for building sources it contributes
tflm/examples/hello_world/models/%.o tflm/examples/hello_world/models/%.su tflm/examples/hello_world/models/%.cyclo: ../tflm/examples/hello_world/models/%.cc tflm/examples/hello_world/models/subdir.mk
...
clean: clean-tflm-2f-examples-2f-hello_world-2f-models

clean-tflm-2f-examples-2f-hello_world-2f-models:
	-$(RM) ./tflm/examples/hello_world/models/hello_world_float_model_data.cyclo ./tflm/examples/hello_world/models/hello_world_float_model_data.d ./tflm/examples/hello_world/models/hello_world_float_model_data.o ./tflm/examples/hello_world/models/hello_world_float_model_data.su ./tflm/examples/hello_world/models/hello_world_int8_model_data.cyclo ./tflm/examples/hello_world/models/hello_world_int8_model_data.d ./tflm/examples/hello_world/models/hello_world_int8_model_data.o ./tflm/examples/hello_world/models/hello_world_int8_model_data.su

.PHONY: clean-tflm-2f-examples-2f-hello_world-2f-models
