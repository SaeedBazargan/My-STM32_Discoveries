...
CC_SRCS += \
../tflm/examples/hello_world/hello_world_test.cc 

CC_DEPS += \
./tflm/examples/hello_world/hello_world_test.d 

OBJS += \
./tflm/examples/hello_world/hello_world_test.o 


# Each subdirectory must supply rules for building sources it contributes
tflm/examples/hello_world/%.o tflm/examples/hello_world/%.su tflm/examples/hello_world/%.cyclo: ../tflm/examples/hello_world/%.cc tflm/examples/hello_world/subdir.mk
...
clean: clean-tflm-2f-examples-2f-hello_world

clean-tflm-2f-examples-2f-hello_world:
	-$(RM) ./tflm/examples/hello_world/hello_world_test.cyclo ./tflm/examples/hello_world/hello_world_test.d ./tflm/examples/hello_world/hello_world_test.o ./tflm/examples/hello_world/hello_world_test.su

.PHONY: clean-tflm-2f-examples-2f-hello_world
