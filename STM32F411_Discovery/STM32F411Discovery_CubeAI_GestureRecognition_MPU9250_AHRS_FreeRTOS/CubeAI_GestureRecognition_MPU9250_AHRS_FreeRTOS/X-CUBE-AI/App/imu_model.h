/**
  ...
  ******************************************************************************
  */
#ifndef AI_IMU_MODEL_H
#define AI_IMU_MODEL_H
...
#define AI_IMU_MODEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_IMU_MODEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_IMU_MODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_IMU_MODEL_IN \
  ai_imu_model_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_IMU_MODEL_IN_SIZE { \
  AI_IMU_MODEL_IN_1_SIZE, \
}
#define AI_IMU_MODEL_IN_SIZE_BYTES { \
  AI_IMU_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_IMU_MODEL_IN_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_IMU_MODEL_IN_1_CHANNEL     (2)
#define AI_IMU_MODEL_IN_1_SIZE        (2)
#define AI_IMU_MODEL_IN_1_SIZE_BYTES  (2)

/******************************************************************************/
#define AI_IMU_MODEL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_IMU_MODEL_OUT \
  ai_imu_model_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_IMU_MODEL_OUT_SIZE { \
  AI_IMU_MODEL_OUT_1_SIZE, \
}
#define AI_IMU_MODEL_OUT_SIZE_BYTES { \
  AI_IMU_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_IMU_MODEL_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_IMU_MODEL_OUT_1_CHANNEL     (3)
#define AI_IMU_MODEL_OUT_1_SIZE        (3)
#define AI_IMU_MODEL_OUT_1_SIZE_BYTES  (3)

/******************************************************************************/
#define AI_IMU_MODEL_N_NODES (4)
 ...
 * @ref ai_imu_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_imu_model_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_imu_model_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_imu_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_IMU_MODEL_*
 * defines into file @ref imu_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_imu_model_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_IMU_MODEL_H */
